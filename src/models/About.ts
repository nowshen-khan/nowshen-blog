...
const AboutSchema = new Schema<AboutDocument>(
	{
		...
		seo: {
			...
			metaDescription: {
				...
				maxlength: 160,
				default:
					"Learn about my professional journey, skills, and experience in technology and development.",
			},
			keywords: [
				{
					type: String,
...
export const About =
	(mongoose.models.About as AboutModel) ||
	mongoose.model<AboutDocument, AboutModel>("About", AboutSchema);
