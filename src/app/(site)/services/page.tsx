...
export const metadata: Metadata = {
  ...
  description: 'Explore our professional services including web development, design, and consulting. Get the perfect solution for your business needs.',
  keywords: ['services', 'web development', 'design', 'consulting', 'solutions'],
};
              ...
              {services.map((service, index) => (
                <Card 
                  ...
                  className={`group hover:shadow-lg transition-all duration-300 ${
                    index % 3 === 1 ? 'lg:transform lg:scale-105 relative z-10 border-primary/20' : ''
                  }`}
                >
